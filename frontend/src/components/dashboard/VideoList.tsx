...
const VideoList = ({ debouncedSearchQuery }: { debouncedSearchQuery: string }) => {
  ...
  const { data: videosResponse, isLoading: isUserVideosLoading } = useQuery<GetVideoIface>({
    queryKey: [`videos`, page, debouncedSearchQuery],
    queryFn: async () => {
